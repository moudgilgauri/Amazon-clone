        ...
        <div className="home">
            <div className="home_container">
                ...
                <div className="home_row">
                   <Product id="10" title="This is a book about practicing, learning, and sharing our experiences with the Lean methodology and the Toyota Production System." image={lean_startup} price={1200} rating={5}/>
